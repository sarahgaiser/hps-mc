...
hps-mc-batch slurm -o -q hps -r 1:100 -m 1500 -E $HPSMC_DIR/bin/hps-mc-env.sh -W 12 -d $RUNDIR -c $JOBDIR/.hpsmc -l $RUNDIR/logs beam_prep_and_slic $JOBDIR/jobs.json
