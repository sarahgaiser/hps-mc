...
hps-mc-batch slurm -o -r 1:1000 -E /sdf/home/s/sgaiser/src/hps-mc/install/bin/hps-mc-env.sh -W 12 -m 6000 -q milano -A HPS:hps-prod -d $RUNDIR  -c $JOBDIR/.hpsmc -l /sdf/data/hps/physics2021/mc/gen/beam/pass_v8beta/HPS_Run2021Pass1_v8beta_14272/logs beam_prep_and_slic $JOBDIR/jobs.json
