...
hps-mc-job-template -j 1 -r 1000 -a vars_14596.json job_14596.json.tmpl jobs_14596.json
#hps-mc-job-template -i pulser pulser_files_14590.txt 1 -j 1 -m 400 -a vars_14596.json job_pulser_evio_14590.json.tmpl jobs_14596.json
