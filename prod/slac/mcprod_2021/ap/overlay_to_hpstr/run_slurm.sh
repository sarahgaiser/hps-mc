...
hps-mc-batch slurm -o -r 1:200 -E /sdf/home/s/sgaiser/src/hps-mc/install/bin/hps-mc-env.sh -W 8 -q milano -A HPS:hps-prod -d $RUNDIR  -c $JOBDIR/.hpsmc -l $RUNDIR/logs signal_pulser_overlay_to_recon $JOBDIR/jobs_ap120.json 
