...
export RUNDIR=/sdf/data/hps/physics2021/run/prod/ap80/overlay/

hps-mc-batch slurm -o -r 1:200 -E /sdf/home/s/sgaiser/src/hps-mc/install/bin/hps-mc-env.sh -W 6 -m 8000 -q roma -A HPS:hps-prod -d $RUNDIR  -c $JOBDIR/.hpsmc -l $RUNDIR/logs signal_pulser_overlay_to_recon $JOBDIR/jobs_ap80_tgt_m0pt1mm.json 
