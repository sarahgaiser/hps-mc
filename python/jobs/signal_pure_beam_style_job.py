...
ana = HPSTR(inputs=cnv.output_files(), outputs=['signal_pure_beam_style_ana.root'], cfg='ana')

## Add the components
job.add([filter_events, count_filter,
         readout, count_readout, recon, count_recon, cnv, ana])
