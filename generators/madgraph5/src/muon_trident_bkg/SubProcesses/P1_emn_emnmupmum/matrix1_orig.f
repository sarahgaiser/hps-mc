...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
      ...
      CALL IXXXXX(P(0,5),MDL_MM,NHEL(5),-1*IC(5),W(1,5))
      CALL OXXXXX(P(0,6),MDL_MM,NHEL(6),+1*IC(6),W(1,6))
      CALL FFV1P0_3(W(1,1),W(1,3),GC_3,ZERO, FK_ZERO,W(1,7))
      CALL FF1P0_3(W(1,2),W(1,4),GC_12,ZERO, FK_ZERO,W(1,8))
      CALL FFV1_2(W(1,5),W(1,7),GC_3,MDL_MM, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,4),W(1,6),W(1,8),GC_3,AMP(1))
      CALL FFV1_1(W(1,6),W(1,7),GC_3,MDL_MM, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,5),W(1,4),W(1,8),GC_3,AMP(2))
      CALL FFV1P0_3(W(1,5),W(1,6),GC_3,ZERO, FK_ZERO,W(1,4))
      CALL FFV1_2(W(1,1),W(1,8),GC_3,MDL_ME, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,6),W(1,3),W(1,4),GC_3,AMP(3))
      CALL FFV1_2(W(1,1),W(1,4),GC_3,MDL_ME, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,6),W(1,3),W(1,8),GC_3,AMP(4))
