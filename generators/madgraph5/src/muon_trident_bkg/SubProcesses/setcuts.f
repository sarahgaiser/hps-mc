...
c-charged-leptons
         ...
         if (idup(i,1,iproc).eq.11)  is_a_em(i)=.true. ! e-
         if (idup(i,1,iproc).eq.-11)  is_a_ep(i)=.true. ! e+
         if (idup(i,1,iproc).eq.13)  is_a_mm(i)=.true. ! mu-
         if (idup(i,1,iproc).eq.-13)  is_a_mp(i)=.true. ! mu+
c-b-quarks
