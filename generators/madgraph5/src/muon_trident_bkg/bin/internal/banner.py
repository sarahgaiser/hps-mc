...
class RunCardLO(RunCard):
    ...
    def default_setup(self):
        ...
        # electron
        self.add_param("eminmu", 0.0, cut='l')
        self.add_param("emaxmu", 100.0, cut='l')
        self.add_param("thetaminmu", 0.0, cut='l')
        self.add_param("thetamaxmu", 100.0, cut='l')
        self.add_param("thetaxminmu", 0.0, cut='l')
        self.add_param("thetaxmaxmu", 100.0, cut='l')
        self.add_param("thetayminmu", 0.0, cut='l')
        self.add_param("thetaymaxmu", 100.0, cut='l')
        # recoil electron
        self.add_param("eminrecoil", 0.0, cut='l')
        self.add_param("emaxrecoil", 100.0, cut='l')
        self.add_param("thetaminrecoil", 0.0, cut='l')
        self.add_param("thetamaxrecoil", 100.0, cut='l')
        self.add_param("thetaxminrecoil", 0.0, cut='l')
        self.add_param("thetaxmaxrecoil", 100.0, cut='l')
        self.add_param("thetayminrecoil", 0.0, cut='l')
        self.add_param("thetaymaxrecoil", 100.0, cut='l')
        # any lepton
        self.add_param("eminanyl", 0.0, cut='l')
        self.add_param("emaxanyl", 100.0, cut='l')
        self.add_param("thetaminanyl", 0.0, cut='l')
        self.add_param("thetamaxanyl", 100.0, cut='l')
        self.add_param("thetaxminanyl", 0.0, cut='l')
        self.add_param("thetaxmaxanyl", 100.0, cut='l')
        self.add_param("thetayminanyl", 0.0, cut='l')
        self.add_param("thetaymaxanyl", 100.0, cut='l')
        # electron-positron pair cuts
        self.add_param("eltot", 0.0, cut='ll')
        self.add_param("mmeemin", 0.0, cut='ll')
        self.add_param("mmeemax", 100.0, cut='ll')
        self.add_param("thetaratiomin", 0.0, cut='ll')
        self.add_param("thetaratiomax", 100.0, cut='ll')
