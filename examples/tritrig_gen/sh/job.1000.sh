...
mkdir -p /scratch/sgaiser/tritrig/1000
cd /scratch/sgaiser/tritrig/1000
/bin/python3 /sdf/group/hps/users/sgaiser/src/hps-mc/install/lib/python/hpsmc/job.py run -o /scratch/sgaiser/tritrig/logs/job.1000.out -e /scratch/sgaiser/tritrig/logs/job.1000.err -l /scratch/sgaiser/tritrig/logs/job.1000.log -d /scratch/sgaiser/tritrig/1000 -c /sdf/group/hps/users/sgaiser/src/hps-mc/examples/tritrig_gen/.hpsmc -i 1000 /sdf/group/hps/users/sgaiser/src/hps-mc/install/lib/python/jobs/tritrig_gen_job.py /sdf/group/hps/users/sgaiser/src/hps-mc/examples/tritrig_gen/jobs.json
